...
int main(int argc, char** argv){
   ...
   //energy vs momentum TProfile
	...
	crossed_muminus_mom_disp.GetYaxis()->SetTitle("MeV^{2}");	
	crossed_muminus_mom_disp.GetXaxis()->SetTitle("MeV^{2}/c^{2}");	
	...
	crossed_muminus_disp.GetYaxis()->SetTitle("MeV^{2}");	
	crossed_muminus_disp.GetXaxis()->SetTitle("MeV^{2}/c^{2}");
	...
	stuck_muminus_disp.GetYaxis()->SetTitle("MeV^{2}");	
	stuck_muminus_disp.GetXaxis()->SetTitle("MeV^{2}/c^{2}");
	...
	new_muminus_disp.GetYaxis()->SetTitle("MeV^{2}");	
	new_muminus_disp.GetXaxis()->SetTitle("MeV^{2}/c^{2}");
	...
	crossed_muminus_mom_mass.GetXaxis()->SetTitle("MeV/c^{2}");
    crossed_muminus_mass.GetXaxis()->SetTitle("MeV/c^{2}");
	new_muminus_mass.GetXaxis()->SetTitle("MeV/c^{2}");
	stuck_muminus_mass.GetXaxis()->SetTitle("MeV/c^{2}");
    ...
    crossed_muminus_mom_energy.GetXaxis()->SetTitle("MeV");
    crossed_muminus_energy.GetXaxis()->SetTitle("MeV");
	new_muminus_energy.GetXaxis()->SetTitle("MeV");
	stuck_muminus_energy.GetXaxis()->SetTitle("MeV");
