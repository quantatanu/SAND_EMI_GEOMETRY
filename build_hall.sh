...
gegede-cli duneggd/Config/JUST_EMI/WORLDggd.cfg \
           ...
           duneggd/Config/JUST_EMI/SAND_EMI.cfg \
           -w World -o ${outdir}/SAND_JUST_EMI.gdml
            read -r -p "Do you want to display \"${outdir}/SAND_JUST_EMI.gdml\"? [y/N] " response
            case "$response" in
                [yY][eE][sS]|[yY]) 
                    cd ROOT_MACROS/BIN/;
                    echo "./geodisplay_gdml \"${outdir}/SAND_JUST_EMI.gdml)\""; 
                    ./geodisplay_gdml "${outdir}/SAND_JUST_EMI.gdml"; 
                    cd $curdir;
                    ;;
                *)
                    do_something_else
